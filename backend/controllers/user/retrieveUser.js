...
export default async (req, res) => {
  try {
    ...
    const profileImagePath = findImageByPrefix(path.join(__dirname, '../../uploads'), `${id}-profile`);
    const backgroundImagePath = findImageByPrefix(path.join(__dirname, '../../uploads'), `${id}-background`);
